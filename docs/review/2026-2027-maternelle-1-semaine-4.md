# Dossier de relecture pédagogique — 1ère maternelle, 2026–2027
...
- **Niveau :** 1ère maternelle · **tranche d’âge du programme :** À aborder avant 4 ans
...
- **Contenu relu ici :** 5 jours · 20 leçons · 30 activités
...
Mise à niveau visuelle de septembre (ADR-048) : des images ont été redessinées (comptine-mains, corps-main, corps-pied, corps-tete, corps-ventre, comptine-bonjour, comptine-compter, histoire-seau-lisa, histoire-tika, histoire-pluie, bonhomme-articule, objet-cuillere, objet-porte, objet-seau, objet-table, objet-chaise). L’empreinte d’une approbation couvre les octets de chaque image montrée à l’enfant ; elle ne correspond donc plus, et les approbations de 7 leçon(s) de cette semaine sont annulées — pas re-tamponnées — en attendant une reconfirmation visuelle. Aucun mot lu à l’enfant ou à l’adulte n’a changé. Leçons concernées : m1-lang-15, m1-lang-16, m1-lang-17, m1-lang-18, m1-lang-19, m1-math-15, m1-art-17.
...
### Encore l’histoire du seau — Le développement et la structuration du langage oral et écrit (10 min)
...
- **Comptine lue à l’enfant — « La pluie tombe »** (2 min, `comptine-la-pluie-tombe`) :
...
### Donne-moi trois — L’acquisition des premiers outils mathématiques (7 min)
...
### Je lance — Agir, s’exprimer, comprendre à travers les activités physiques (6 min)
...
### On commence, c’est fini — Se repérer dans le temps et l’espace (7 min)
...
- **Objectifs enseignés :**
- **Objectifs repris (déjà vus) :**
  - `TIME-SPACE-S01-C03-O02` — Repérer le début et la fin d’une activité.
...
- **Matériel :** Aucun matériel
- **Aide en anglais (optionnelle) :** « We start… and now it is finished. »
- **Objectifs travaillés :** `TIME-SPACE-S01-C03-O02` Repérer le début et la fin d’une activité.

**Réussites attendues — texte officiel pour la compétence « Construire la notion de durée » (before-4) :**

- Attendre son tour pour jouer, attendre que les camarades soient servis avant de manger un biscuit.
- Comprendre le code défini par les professeurs pour débuter et terminer une activité (le son de la clochette, frapper dans les mains, une consigne orale).
- Comprendre et utiliser le vocabulaire spécifique : attendre, longtemps, déjà, etc. « Je suis déjà allé en salle de motricité. », « La Belle au Bois dormant dort longtemps. », etc.
...
**Durée totale : 30 min** · 4 séances · jour 16 du rythme
...
- **Objectifs repris (déjà vus) :**
  - `LANG-S01-C04-O01` — Entrer en communication verbale avec un adulte ou un autre élève.
  - `TIME-SPACE-S01-C01-O01` — Acquérir les premiers repères temporels.
  - `LANG-S02-C01-O01` — Identifier les sons de la langue, lors de situations d’écoute proposées par le professeur.
  - `ART-S02-C01-O03` — Dire ou chanter au moins cinq comptines.
...
- **Comptine lue à l’enfant — « Un, deux, trois, mes mains »** (2 min, `comptine-un-deux-trois-mains`) :
...
### Les formes ensemble — L’acquisition des premiers outils mathématiques (7 min)
...
#### 1. Les formes ensemble — 7 min, sans interaction écran (sorting)

- **Consigne à l’enfant :** « Mets ensemble ce qui a la même forme. »
- **Guidance adulte :** Donnez deux formes très différentes — des ronds et des carrés — et deux tas. Montrez un exemple de chaque, puis laissez-le faire. S’il trie par couleur, ce n’est pas une erreur : dites « Oui, tu as mis les rouges ensemble. Maintenant, essaie les ronds ensemble. »
...
- Reconnaitre visuellement et tactilement des objets de même forme qu’un objet donné.
- Classer selon leur forme des objets qui diffèrent aussi par d’autres critères.
- Encastrer des objets.
- À partir d’un modèle, reproduire un assemblage à l’échelle d’au plus quatre éléments (puzzle, pavage, assemblage de solides).
...
### Je marche sur la ligne — Agir, s’exprimer, comprendre à travers les activités physiques (6 min)
...
### Je touche — Découvrir le monde du vivant, de la matière et des objets (7 min)
...
**Durée totale : 30 min** · 4 séances · jour 17 du rythme
...
### Je montre le personnage — Le développement et la structuration du langage oral et écrit (10 min)
...
- **Objectifs repris (déjà vus) :**
  - `LANG-S01-C04-O01` — Entrer en communication verbale avec un adulte ou un autre élève.
  - `TIME-SPACE-S01-C01-O01` — Acquérir les premiers repères temporels.
  - `LANG-S02-C03-O03` — Reconnaitre un personnage, le nommer et le situer dans les illustrations.
  - `ART-S02-C01-O03` — Dire ou chanter au moins cinq comptines.
...
- **Comptine lue à l’enfant — « Je marche, je m’arrête »** (2 min, `comptine-je-marche`) :
...
### La comptine des nombres — L’acquisition des premiers outils mathématiques (7 min)
...
### Je bouge comme toi — Agir, s’exprimer, comprendre à travers les activités physiques (6 min)
...
### Ma comptine — Agir, s’exprimer, comprendre à travers les activités artistiques (7 min)
...
**Durée totale : 31 min** · 4 séances · jour 18 du rythme
...
- **Comptine lue à l’enfant — « Le petit seau »** (2 min, `comptine-le-petit-seau`) :
...
### Donne-moi deux, puis trois — L’acquisition des premiers outils mathématiques (7 min)
...
### Je cours — Agir, s’exprimer, comprendre à travers les activités physiques (6 min)
...
### Le moment de la journée — Se repérer dans le temps et l’espace (7 min)
...
#### 1. Le moment de la journée — 7 min, sans interaction écran (observation)

- **Consigne à l’enfant :** « C’est le matin, le midi, ou le soir ? »
- **Guidance adulte :** Le matin et le soir sont maintenant travaillés depuis trois semaines : ajoutez « midi » et faites choisir entre les trois. Dites le moment qu’on vit et ce qui va avec. S’il hésite entre midi et soir, revenez aux deux moments d’avant — on ne force pas le troisième.
- **Matériel :** Aucun matériel
- **Aide en anglais (optionnelle) :** « Is it morning, midday or evening? »
...
**Durée totale : 30 min** · 4 séances · jour 19 du rythme
...
**Matériel à préparer :** Aucun matériel, Balle en papier froissé, Boîte, seau ou récipient, Crayon, Formes découpées ou dessinées sur papier (carré, rectangle, triangle, disque), Feuille de papier
...
- **Comptine lue à l’enfant — « Bonjour, petit »** (2 min, `comptine-bonjour-petit`) :
...
### Je dessine — Agir, s’exprimer, comprendre à travers les activités artistiques (7 min)
