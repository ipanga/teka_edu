...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Database size             | 500 MB, then **read-only**                                                                                                                                     | OK / Monitor                                           | Curriculum stays in Git (ADR-019). The database holds user data (none yet) plus the generated mirror of the reference data: **about 2 MB** for 28 tables including indexes (398 objectives, 529 success examples, the pilot lessons), well under 1% of the quota. |
