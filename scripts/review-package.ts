/**
 * Writes the human review package for the pilot week (docs/PEDAGOGICAL_REVIEW.md, ADR-035).
 *
 *   npm run review:package
 *   npm run review:package -- --level=maternelle-3 --year=2026-2027 --days=5
 *
